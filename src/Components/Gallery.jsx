      ...
      <div className="Gallery_modalOverlay" onClick={() => setPreviewData(null)}>
        <div className="Gallery_modalContent" onClick={(e) => e.stopPropagation()}>
          <div className="Gallery_modalHeader">
            <div className="Gallery_modalTitle"><FiCode /> <span>Preview: {previewData.date}</span></div>
            <button className="Gallery_closeBtn" onClick={() => setPreviewData(null)}><FiX /></button>
          </div>
          <div className="Gallery_modalBody">
            <iframe
              title="Full Preview"
              srcDoc={`<html><style>${previewData.css}</style><body>${previewData.html}<script>${previewData.js}</script></body></html>`}
              className="Gallery_fullIframe"
            />
          </div>
  ...
  return (
    <div className="Gallery_container Gallery_fadePage">
      ...
      <div className="Gallery_header Gallery_slideDown">
        ...
        {loading && <div className="Gallery_loading">Syncing Gallery...</div>}
      </div>
      
      <div className="Gallery_gridWrapper">
          <div className="Gallery_grid">{renderGridItems()}</div>
      </div>
    </div>
  );
};
